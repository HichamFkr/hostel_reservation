                 ...
                 <!-- /. ROW  -->
                  ...
                  <div class="container col-md-8 col-md-offset-2">
                      <div class="alert alert-success" role="alert">
                        <strong>Reservation a été ajouté avec suceée</strong>
                      </div>
                       <div class="form-group">
                           ...
                           <div class="form-group">
                           <strong>  <label>Date début de la réservation :    </label></strong>
                             <label>${reM.dateD}</label>
                           </div>
                           
                           <div class="form-group">
                           <strong>  <label>Date fin de la réservation ::    </label></strong>
