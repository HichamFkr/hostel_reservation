...
<body>
    ...
    <div id="wrapper">
         ...
         <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="clients.jsp"><i class="fa fa-home "></i>clients</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
                 ...
                 <!-- /. ROW  -->
                  ...
                  <div class="container col-md-8 col-md-offset-2">
                      <div class="alert alert-success" role="alert">
                        <strong>Client a été Modfiée avec succée</strong>
                      </div>
            ...
            <div class="form-group">
            <strong>  <label>Nationalité:   </label></strong>
            ...
            <div class="form-group">
             <strong> <label>ID Card:   </label></strong>
